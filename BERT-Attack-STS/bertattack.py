...
def run_attack():
    ...
    tgt_model = BertForSequenceClassification.from_pretrained("bert-base-uncased")
    tgt_model = BertForSequenceClassification.from_pretrained("bert-base-uncased", num_labels=num_label)
